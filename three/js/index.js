...
var ambientLight = void 0,hemisphereLight = void 0,shadowLight = void 0;
...
var Bee = function Bee() {
  ...
  //HEAD
  var geomHead = new THREE.SphereGeometry(55, 32, 32);
  ...
  //BODY1
  var geomBody1 = new THREE.SphereGeometry(65, 32, 32);
  var matBody1 = new THREE.MeshPhongMaterial({
    color: Colors.yellow,
    shading: THREE.FlatShading });
  ...
  //BODY2
  var geomBody2 = new THREE.SphereGeometry(70, 32, 32);
  var matBody2 = new THREE.MeshPhongMaterial({
    color: Colors.black,
    shading: THREE.FlatShading });
  ...
  //BODYWING
  var geomBodyWing = new THREE.SphereGeometry(30, 32, 32);
  var matBodyWing = new THREE.MeshPhongMaterial({
    color: Colors.black,
    shading: THREE.FlatShading });
  ...
  //BODY3
  var geomBody3 = new THREE.SphereGeometry(65, 32, 32);
  var matBody3 = new THREE.MeshPhongMaterial({
    color: Colors.yellow,
    shading: THREE.FlatShading });
  ...
  //TAIL
  var geomTail = new THREE.SphereGeometry(45, 32, 32);
  ...
  //WINGS
  var geomWing = new THREE.Geometry();
  ...
  //STING
  var geomDard = new THREE.CylinderGeometry(20, 0, 50, 10);
  var matDard = new THREE.MeshPhongMaterial({
    color: Colors.white,
    shading: THREE.FlatShading });
...
Sea = function Sea() {
  var geom = new THREE.CylinderGeometry(480, 480, 2900, 100, 34);
  geom.mergeVertices();
...
function updateBee() {
  ...
  if (targetZ > 0) {
    ...
    for (var _i = 0; _i < p.length; _i++) {
      p[_i].mesh.rotation.x += 0.001 + -targetZ / 30000;
    }
  }
  ...
  var normalisedSpeed = Math.sqrt(targetZ * targetZ);
